...
function StepperIndicator({
  ...
  return (
    <span
      ...
      className={cn(
        'bg-white text-muted-foreground data-[state=active]:bg-primary data-[state=completed]:bg-primary data-[state=active]:text-white data-[state=completed]:text-primary-foreground relative flex size-6 shrink-0 items-center justify-center rounded-full text-xs font-medium',
        className,
      )}
      data-state={state}
      {...props}
...
function StepperSeparator({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      ...
      className={cn(
        'bg-white dark:bg-gray-500 group-data-[state=completed]/step:bg-primary dark:group-data-[state=completed]/step:bg-primary  m-0.5 group-data-[orientation=horizontal]/stepper:h-[3px] group-data-[orientation=horizontal]/stepper:w-full group-data-[orientation=horizontal]/stepper:flex-1 group-data-[orientation=vertical]/stepper:h-12 group-data-[orientation=vertical]/stepper:w-0.5',
        className,
      )}
      {...props}
    />
