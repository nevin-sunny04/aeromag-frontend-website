...
export default function GalleryModal({ images }: { images: GalleryItem }) {
    ...
    <>
      ...
      >
        <DialogContent
          ...
          className=" p-4 !max-w-[60vw] w-[1200px] z-998 h-[95vh] overflow-auto"
        >
          <DialogTitle className="sub-heading ">{images.title}</DialogTitle>
          <BentoGallery
